    ...
    const fetchUserData = async () => {
      try {
        ...
        const response = await fetch(
          `http://localhost:8080/getUserId/${userId}`
        );
        if (!response.ok) {
        ...
        <div className="ProductForm-forms-container">
          ...
          <form onSubmit={handleSubmit}>
            <div className="ProductForm-forms-form">
              ...
              <h2>
                Adicione fotos da sua doação <FaRegSmileWink />
              </h2>
              <div className="ProductForm-forms-image-container">
                {images.map((image) => (
                  <div
                    key={image.id}
                    className="ProductForm-forms-image-preview"
                  >
                    <img
                      src={image.src}
                      alt="Imagem"
                    ...
                    <button
                      ...
                      className="ProductForm-forms-remove-button"
                    >
                      X
                    </button>
                  </div>
                ...
                {!handleButtonDisabled && (
                  <label className="ProductForm-forms-add-image">
                    ...
                    <input
                      ...
                      className="ProductForm-forms-input-file"
                    />
                  </label>
                )}
              </div>
            ...
            <div className="ProductForm-forms-form-group">
              <input
                type="text"
                id="titulo"
                className="ProductForm-forms-input-field"
                placeholder="Título"
                value={titulo}
            ...
            <div className="ProductForm-forms-form-group">
              <div className="ProductForm-forms-input-field-container">
                <input
                  ...
                  min="1"
                  value={quantidade}
                  onInput={handleQuantidadeChange}
                />
              </div>
              <div className="ProductForm-forms-input-field-container">
                <select
            ...
            <div className="ProductForm-forms-form-group">
              <label htmlFor="disponibilidade">
                Tem disponibilidade para levar até o interessado?
              </label>
              <select
